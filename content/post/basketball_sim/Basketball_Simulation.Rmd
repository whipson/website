...
game1 <- animate(p, nframes = 1062, width = 500, height = 500, fps = 10, end_pause = 12)
...
```{r message = FALSE, warning = FALSE, echo = FALSE}
game <- game_simulation(n_seconds = 1000, n_fans = 25, team1_prob = .0165)
...
game2 <- animate(p2, nframes = 1062, width = 500, height = 500, fps = 10, end_pause = 12)
