...
This series of blog posts, which I kicked off earlier this month with a [simulation of emotions during basketball games](https://willhipson.netlify.com/post/basketball_sim/basketball_sim/), is inspired by researchers like [Peter Kuppens](https://ppw.kuleuven.be/okp/people/Peter_Kuppens/) and [Tom Hollenstein](https://www.queensu.ca/psychology/people/faculty/tom-hollenstein) (to name a few) who have collected and analyzed reams of intensive self-reports on people's feelings from one moment to the next. My approach is to reverse engineer these insights and generate models that *simulate* emotions evolving over time - like this:
...
We can get a sense of one simulated person's affective state space as well. The goal here is to mimic the kinds of models shown in [Kuppens, Oravecz, and Tuerlinckx (2010)](https://www.ncbi.nlm.nih.gov/pubmed/20853980):
...
[Kuppens, P., Oravecz, Z., & Tuerlinckx, F. (2010). Feelings change: Accounting for individual differences in the temporal dynamics of affect. *Journal of Personality and Social Psychology, 99*, 1042-1060](https://www.ncbi.nlm.nih.gov/pubmed/20853980)
